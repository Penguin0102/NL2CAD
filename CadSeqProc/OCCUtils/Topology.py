...
class topods:
    @staticmethod
    def Edge(shape): return shape if shape.ShapeType() == TopAbs_EDGE else None
    @staticmethod
    def Vertex(shape): return shape if shape.ShapeType() == TopAbs_VERTEX else None
    @staticmethod
    def Wire(shape): return shape
    @staticmethod
    def Face(shape): return shape

def topods_Edge(shape):
    return shape if shape.ShapeType() == TopAbs_EDGE else TopoDS_Edge()

def topods_Vertex(shape):
    return shape if shape.ShapeType() == TopAbs_VERTEX else TopoDS_Vertex()
